...
import { hydrateExperimentDashboard } from 'src/dashboard/actions/hydrateExperiment';
...
export const DashboardPage: FC<PageProps> = ({ idOrSlug }: PageProps) => {
  ...
  useEffect(() => {
    ...
    // .............custom_code_end
    if (id && !experimentId) getDataMaskApplied();
    ...
    async function getExperimentDataMaskApplied() {
      ...
      if (readyToRender) {
        ...
        try {
          ...
          const url = `https://pokus.makemytrip.com/measurement/experiment/${experimentId}/chart`;
          ...
          console.log(
            '🚀 ~ file: DashboardPage.tsx:488 ~ getExperimentDataMaskApplied ~ err:',
            err,
          );
        }
